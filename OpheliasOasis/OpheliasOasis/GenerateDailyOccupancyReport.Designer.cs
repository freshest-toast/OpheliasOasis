...
{
    partial class GenerateDailyOccupancyReport
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            //this.Text = "GenerateDailyOccupancyReport";
            ...
            this.Name = "DailyOccupancyReport";
            this.Text = "Daily Occupancy Report";
            this.Load += new System.EventHandler(this.GenerateDailyOccupancyReport_Load);
            this.ResumeLayout(false);

            LocalReport localReport = reportViewer1.LocalReport;

            ReportDataSource a = new ReportDataSource();
            a.Name = "DailyOccupancyReport";
