...
namespace OpheliasOasis
{
    public partial class GenerateExpectedOccupancyReport : Form
    {
        ...
        public GenerateExpectedOccupancyReport()
        {
            ...
            dialogWindow.FileName = "Expected Occupancy Report";
            ...
            DataTable table = DatabaseManager.getExpectedOccupancyReport();
        ...
        private void InitializeComponent()
        {
            ...
            this.output.Text = "Expected Occupancy Report Saved Successfully";
            // 
