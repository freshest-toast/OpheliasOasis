...
{
    public partial class GenerateDailyArrivalsReport : Form
    {
        private TextBox output;

        public GenerateDailyArrivalsReport()
        {
            ...
            dialogWindow.FileName = "Daily Arrivals Report";
            ...
            DataTable table = DatabaseManager.getDailyArrivalsReport();
        ...
        private void InitializeComponent()
        {
            ...
            this.output.Text = "Daily Arrivals Report Saved Successfully";
            // 
            // GenerateDailyArrivalsReport
            // 
            this.ClientSize = new System.Drawing.Size(300, 200);
            this.Controls.Add(this.output);
            this.Name = "GenerateDailyArrivalsReport";
