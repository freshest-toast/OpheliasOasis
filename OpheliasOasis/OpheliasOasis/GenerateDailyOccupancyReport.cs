...
{
    public partial class GenerateDailyOccupancyReport : Form
    {
        private TextBox output;

        public GenerateDailyOccupancyReport()
        {
            ...
            dialogWindow.FileName = "Daily Occupancy Report";
            ...
            DataTable table = DatabaseManager.getDailyOccupancyReport();
        ...
        private void InitializeComponent()
        {
            ...
            this.output.Text = "Daily Occupancy Report Saved Successfully";
            // 
            // GenerateDailyOccupancyReport
            // 
            this.ClientSize = new System.Drawing.Size(300, 200);
            this.Controls.Add(this.output);
            this.Name = "GenerateDailyOccupancyReport";
